...
#define STRING_VERSION_CONFIG_H "MendelMax_2-0_RAMBo_1-2_GLCD" __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Maker's Tool Works edited Jan 18, 2014" // Who made the changes.
